...
logging.basicConfig(format="%(levelname)s (%(name)s %(lineno)s): %(m\
essage)s")
...
def apply_rf_model(vds, rf_pipeline, rf_features, label='va.label', va_root='va.rf', globals_root='global.rf'):
    """
